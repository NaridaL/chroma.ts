...
### `chroma`(_red255_: number, _green255_: number, _blue255_: number, _alpha1_: number = 1): [Color](#Color) <sub><a href="src/index.ts#L89">src</a></sub>

_example_ `chroma(99, 99, 44, 0.7)` <img align="right" src="./readme_img/63632cb3.svg">  

### `chroma`(_x_: [chroma.Chromable](#chroma.Chromable), _format_?: [ColorFormat](#ColorFormat)): [Color](#Color) <sub><a href="src/index.ts#L96">src</a></sub>
...
### `chroma`(_colorname_: typeof \[object Object\], _format_?: undefined | `"name"`): [Color](#Color) <sub><a href="src/index.ts#L100">src</a></sub>

This overload allows VS Code to suggest color names when you type `chroma('`.

### `chroma`(_channel0_: number, _channel1_: [Color](#Color), _channel2_: number, _format_: [ColorFormat](#ColorFormat)): [Color](#Color) <sub><a href="src/index.ts#L102">src</a></sub>

_example_ `chroma(30, 0.8, 0.3, 'hsl')` <img align="right" src="./readme_img/8a4d0fff.svg">  

### `chroma`(_channel0_: number, _channel1_: [Color](#Color), _channel2_: number, _channel3_: number, _format_: [ColorFormat](#ColorFormat)): [Color](#Color) <sub><a href="src/index.ts#L104">src</a></sub>
...
### `color.mix`(_col2_: [Chromable](#Chromable), _f_: number, _m_: [InterpolationMode](#InterpolationMode) = "rgb"): [Color](#Color) <sub><a href="src/index.ts#L209">src</a></sub>

@see \[\[chroma.mix\]\]

### `color.rgb`(_doRound_: boolean = true, _clamp\__: boolean = true): [RGB](#RGB) <sub><a href="src/index.ts#L212">src</a></sub>

### `color.rgba`(_doRound_: boolean = true, _clamp\__: boolean = true): [RGBA](#RGBA) <sub><a href="src/index.ts#L221">src</a></sub>

### `color.hex`(_mode_: `"rgb"` | `"rgba"` | `"argb"` = "rgb"): string <sub><a href="src/index.ts#L240">src</a></sub>
...
### `color.hsl`(): [HSL](#HSL) <sub><a href="src/index.ts#L250">src</a></sub>
...
### `color.hsv`(): Object <sub><a href="src/index.ts#L260">src</a></sub>

Returns the HSL representation of this color. hue will always be in \[0;360). Values are never NaN.

_example_ `chroma('purple').hsv()` \[300, 1, ~0.5\]  

### `color.hcg`(): Object <sub><a href="src/index.ts#L270">src</a></sub>

Returns the HSL representation of this color. hue will always be in \[0;360). Values are never NaN.

_example_ `chroma('purple').hcg()` \[300, ~0.5, 0\]  

### `color.css`(_mode_: `"rgb"` | `"hsl"` = "rgb"): string <sub><a href="src/index.ts#L282">src</a></sub>
...
### `color.name`(_closest_: true): string <sub><a href="src/index.ts#L293">src</a></sub>

### `color.name`(_closest_: false | true = false): string | undefined <sub><a href="src/index.ts#L305">src</a></sub>
...
### `color.cmyk`(): Object <sub><a href="src/index.ts#L324">src</a></sub>

Get the [CMYK](#chroma.CMYK) representation of this color.

_example_ `chroma('red').cmyk()` \[0, 1, 1, 0\]  

### `color.gl`(): [GL](#GL) <sub><a href="src/index.ts#L333">src</a></sub>

Returns the GL representation of this color.

_example_ `chroma('33cc00').gl()` \[0.2, 0.8, 0, 1\]  

### `color.luminance`(): number <sub><a href="src/index.ts#L345">src</a></sub>
...
### `color.luminance`(_lum1_: number): this <sub><a href="src/index.ts#L354">src</a></sub>
...
### `color.temperature`(): number <sub><a href="src/index.ts#L379">src</a></sub>
...
### `color.set`(_modeAndChannel_: string, _value_: number | ((_channel_: number) => number)): [Color](#Color) <sub><a href="src/index.ts#L391">src</a></sub>
...
### `color.clipped`(): boolean <sub><a href="src/index.ts#L409">src</a></sub>
...
### `color.textColor`(): [Color](#Color) <sub><a href="src/index.ts#L421">src</a></sub>
...
### `color.alpha`(): number <sub><a href="src/index.ts#L429">src</a></sub>

Get alpha value of color.

_example_ `chroma.rgb(0, 0, 255, 0.5).alpha()` `0.5`  

### `color.alpha`(_alpha1_: number): [Color](#Color) <sub><a href="src/index.ts#L436">src</a></sub>
...
### `color.darker`(_amount_: number = 1): [Color](#Color) <sub><a href="src/index.ts#L445">src</a></sub>

### `color.brighter`(_amount_: number = 1): [Color](#Color) <sub><a href="src/index.ts#L458">src</a></sub>
...
### `color.saturate`(_amount_: number = 1): [Color](#Color) <sub><a href="src/index.ts#L470">src</a></sub>
...
### `color.desaturate`(_amount_: number = 1): [Color](#Color) <sub><a href="src/index.ts#L479">src</a></sub>

Equivalent to `saturate(-amount)`.

@see #saturate

### `color.premultiplied`(): [Color](#Color) <sub><a href="src/index.ts#L483">src</a></sub>

### `color.hsi`(): Object <sub><a href="src/index.ts#L493">src</a></sub>
...
### `color.lab`(): Object <sub><a href="src/index.ts#L503">src</a></sub>

Returns the LAB representation of this color.

_example_ `chroma('purple').lab()` \[~29.78, ~58.93, ~-36.49\]  

### `color.num`(_mode_: `"rgb"` | `"rgba"` | `"argb"` = "rgb"): number <sub><a href="src/index.ts#L517">src</a></sub>
...
### `color.lch`(): Object <sub><a href="src/index.ts#L527">src</a></sub>
...
### `color.xyz`(): Object <sub><a href="src/index.ts#L537">src</a></sub>
...
### `color.equals`(_color_: [Color](#Color)): boolean <sub><a href="src/index.ts#L545">src</a></sub>

Whether this [Color](#chroma.Color) is identical (strict equality of r, g, b, a) to `color`.

### `color.hashCode`(): number <sub><a href="src/index.ts#L551">src</a></sub>

### `color.toSource`(): string <sub><a href="src/index.ts#L559">src</a></sub>
...
### `color.toString`(): string <sub><a href="src/index.ts#L565">src</a></sub>

### `color.kelvin`(): number <sub><a href="src/index.ts#L568">src</a></sub>
...
### `chroma.cubehelix`(_start_: number = 300, _rotations_: number = -1.5, _hue_: number | \[number, number\] = 1, _gamma_: number = 1, _lightness_: number | \[number, number\] = \[0, 1\]): [CubeHelix](#CubeHelix) <sub><a href="src/index.ts#L925">src</a></sub>
...
### `cubehelix`(_f_: number): [Color](#Color) <sub><a href="src/index.ts#L949">src</a></sub>

[Dave Green's cubehelix color scheme](http://www.mrao.cam.ac.uk/~dag/CUBEHELIX/)!

A CubeHelix is a function defined on 0, 1 which returns colors.

### `cubehelix.start`(_s_: number): number | this <sub><a href="src/index.ts#L958">src</a></sub>

### `cubehelix.rotations`(_r_: number): number | this <sub><a href="src/index.ts#L965">src</a></sub>

### `cubehelix.gamma`(_g_: number): number | this <sub><a href="src/index.ts#L972">src</a></sub>

### `cubehelix.hue`(_h_: number | \[number, number\]): Object | this <sub><a href="src/index.ts#L979">src</a></sub>

### `cubehelix.lightness`(_h_: number | \[number, number\]): Object | this <sub><a href="src/index.ts#L986">src</a></sub>

### `cubehelix.scale`(): [Scale](#Scale) <sub><a href="src/index.ts#L999">src</a></sub>
...
### `cubehelix.at`(_fract_: number): [Color](#Color) <sub><a href="src/index.ts#L1003">src</a></sub>

### `chroma.random`(_randomSource_: [random](#random) = Math.random): [Color](#Color) <sub><a href="src/index.ts#L1022">src</a></sub>

Create a new random Color from a random point in the RGB color space.

### `chroma.mix`(_col1_: [Chromable](#Chromable), _col2_: [Chromable](#Chromable), _f_: number = 0.5, _m_: [InterpolationMode](#InterpolationMode) = "rgb"): [Color](#Color) <sub><a href="src/index.ts#L1075">src</a></sub>
...
### `chroma.css`(_cssString_: string): [Color](#Color) <sub><a href="src/index.ts#L1092">src</a></sub>
...
### `chroma.cmyk`(_cmyk_: [CMYK](#CMYK)): [Color](#Color) <sub><a href="src/index.ts#L1101">src</a></sub>
...
### `chroma.cmyk`(_cyan1_: number, _magenta1_: number, _yellow1_: number, _key1_: number): [Color](#Color) <sub><a href="src/index.ts#L1102">src</a></sub>

### `chroma.gl`(_gl_: [RGBA](#RGBA) | [RGB](#RGB)): [Color](#Color) <sub><a href="src/index.ts#L1110">src</a></sub>

_example_ `chroma.gl(1, 1, 0, 1)` <img align="right" src="./readme_img/ffff00ff.svg">  

### `chroma.gl`(_red1_: number, _green1_: number, _blue1_: number, _alpha1_: number): [Color](#Color) <sub><a href="src/index.ts#L1114">src</a></sub>

_example_ `chroma.gl([1, 0, 1, 0.5])` <img align="right" src="./readme_img/ff00ff80.svg">  

### `chroma.hcg`(_hcg_: [HCG](#HCG)): [Color](#Color) <sub><a href="src/index.ts#L1119">src</a></sub>

### `chroma.hcg`(_h_: number, _c_: number, _g_: number, _alpha1_: number = 1): [Color](#Color) <sub><a href="src/index.ts#L1123">src</a></sub>

### `chroma.lch`(_lch_: [LCH](#LCH)): [Color](#Color) <sub><a href="src/index.ts#L1128">src</a></sub>

### `chroma.lch`(_h_: number, _c_: number, _l_: number, _alpha1_: number = 1): [Color](#Color) <sub><a href="src/index.ts#L1132">src</a></sub>

### `chroma.hsi`(_hsi_: [HSI](#HSI)): [Color](#Color) <sub><a href="src/index.ts#L1137">src</a></sub>

### `chroma.hsi`(_h_: number, _s_: number, _i_: number, _alpha1_: number = 1): [Color](#Color) <sub><a href="src/index.ts#L1141">src</a></sub>

### `chroma.hsl`(_hsl_: [HSL](#HSL)): [Color](#Color) <sub><a href="src/index.ts#L1146">src</a></sub>

### `chroma.hsl`(_hueDegrees_: number, _saturation1_: number, _lightness1_: number, _alpha1_: number = 1): [Color](#Color) <sub><a href="src/index.ts#L1152">src</a></sub>
...
### `chroma.hsv`(_hsv_: [LAB](#LAB)): [Color](#Color) <sub><a href="src/index.ts#L1157">src</a></sub>

### `chroma.hsv`(_h_: number, _s_: number, _v_: number): [Color](#Color) <sub><a href="src/index.ts#L1158">src</a></sub>

### `chroma.kelvin`(_temperature_: number): [Color](#Color) <sub><a href="src/index.ts#L1171">src</a></sub>
...
### `chroma.lab`(_lab_: [LAB](#LAB)): [Color](#Color) <sub><a href="src/index.ts#L1176">src</a></sub>

### `chroma.lab`(_lightness1_: number, _a1_: number, _b_: number, _alpha1_: number = 1): [Color](#Color) <sub><a href="src/index.ts#L1180">src</a></sub>

### `chroma.num`(_num_: number): [Color](#Color) <sub><a href="src/index.ts#L1188">src</a></sub>

_example_ `chroma.num(0x663399) // rebeccapurple` <img align="right" src="./readme_img/663399ff.svg">  

### `chroma.rgb`(_rgb_: [RGBA](#RGBA) | [RGB](#RGB)): [Color](#Color) <sub><a href="src/index.ts#L1193">src</a></sub>

### `chroma.rgb`(_red255_: number, _green255_: number, _blue255_: number, _alpha1_: number = 1): [Color](#Color) <sub><a href="src/index.ts#L1198">src</a></sub>

_example_ `chroma.rgb(0, 100, 200)` <img align="right" src="./readme_img/0064c8ff.svg">  

### `chroma.xyz`(_xyz_: [XYZ](#XYZ)): [Color](#Color) <sub><a href="src/index.ts#L1203">src</a></sub>

### `chroma.xyz`(_x1_: number, _y1_: number, _z1_: number, _alpha1_: number = 1): [Color](#Color) <sub><a href="src/index.ts#L1205">src</a></sub>

### `chroma.average`(_chromables_: [Chromable](#Chromable)\[\], _mode_: [InterpolationMode](#InterpolationMode) = "rgb"): [Color](#Color) <sub><a href="src/index.ts#L1220">src</a></sub>
...
### `chroma.bezier`(_chromables_: [Chromable](#Chromable)\[\]): (_t_: number) => [Color](#Color) <sub><a href="src/index.ts#L1270">src</a></sub>
...
### `chroma.blend`(_bottom_: [Chromable](#Chromable), _top_: [Chromable](#Chromable), _mode_: [BlendMode](#BlendMode)): [Color](#Color) <sub><a href="src/index.ts#L1288">src</a></sub>
...
### `chroma.scale`(_colors_: [Chromable](#Chromable)\[\] | typeof \[object Object\] | ((_f_: number) => [Color](#Color))): [Scale](#Scale) <sub><a href="src/index.ts#L1314">src</a></sub>
...
### `chroma.scale`(..._colors_: [Chromable](#Chromable)\[\]): [Scale](#Scale) <sub><a href="src/index.ts#L1315">src</a></sub>
...
### `scale`(_val_: number): T <sub><a href="src/index.ts#L1336">src</a></sub>

A color scale, created with chroma.scale, is a function that maps numeric values to a color palette.

The type parameter describes the output type and can be changed with out(). Defaults to Color objects.

### `scale.classes`(): number\[\] <sub><a href="src/index.ts#L1361">src</a></sub>

Get the current scale classes.

### `scale.classes`(_classes_: number | number\[\]): this <sub><a href="src/index.ts#L1372">src</a></sub>
...
### `scale.domain`(): number\[\] <sub><a href="src/index.ts#L1394">src</a></sub>

Get the domain.

_example_ `chroma.scale("red", "white", "blue").domain(0, 20).domain()` \[0, 10, 20\]  

### `scale.domain`(_start_: number, _end_: number): this <sub><a href="src/index.ts#L1404">src</a></sub>
...
### `scale.domain`(..._domain_: number\[\]): this <sub><a href="src/index.ts#L1416">src</a></sub>
...
### `scale.mode`(): [InterpolationMode](#InterpolationMode) <sub><a href="src/index.ts#L1441">src</a></sub>

Get the interpolation mode used when calculating colors.

### `scale.mode`(_mode_: [InterpolationMode](#InterpolationMode)): this <sub><a href="src/index.ts#L1450">src</a></sub>
...
### `scale.out`&lt;M&gt;(_outputFormat_: M): [Scale](#Scale) <sub><a href="src/index.ts#L1467">src</a></sub>
...
### `scale.correctLightness`(_enableCorrectLightness_: boolean = true): this <sub><a href="src/index.ts#L1482">src</a></sub>
...
### `scale.padding`(): \[number, number\] <sub><a href="src/index.ts#L1507">src</a></sub>

Get the padding.

### `scale.padding`(_paddingLeft_: number, _paddingRight_: number = paddingLeft): this <sub><a href="src/index.ts#L1518">src</a></sub>
...
### `scale.colors`(_numColors_?: undefined | number, _format_: [ColorFormat](#ColorFormat) | false = "hex"): T\[\] <sub><a href="src/index.ts#L1538">src</a></sub>
...
### `scale.cache`(): boolean <sub><a href="src/index.ts#L1568">src</a></sub>

Get whether the cache is enabled. Defaults to true.

### `scale.cache`(_enableCache_: boolean): this <sub><a href="src/index.ts#L1573">src</a></sub>

Enable or disable the cache.

### `scale.gamma`(): number <sub><a href="src/index.ts#L1585">src</a></sub>

Get the current gamma value. Defaults to 1.

### `scale.gamma`(_gamma_: number): this <sub><a href="src/index.ts#L1593">src</a></sub>
...
### `scales.cool`(): [Scale](#Scale) <sub><a href="src/index.ts#L1703">src</a></sub>
...
### `scales.hot`(): [Scale](#Scale) <sub><a href="src/index.ts#L1710">src</a></sub>
...
### `chroma.contrast`(_a_: [Chromable](#Chromable), _b_: [Chromable](#Chromable)): number <sub><a href="src/index.ts#L1723">src</a></sub>
...
### `chroma.distance`(_a_: [Chromable](#Chromable), _b_: [Chromable](#Chromable), _mode_: [ColorMode](#ColorMode) = "lab"): number <sub><a href="src/index.ts#L1744">src</a></sub>
...
### `chroma.deltaE`(_reference_: [Chromable](#Chromable), _sample_: [Chromable](#Chromable), _L_: number = 1, _C_: number = 1): number <sub><a href="src/index.ts#L1767">src</a></sub>
...
### `chroma.analyze`(_data_: number\[\]): [DataInfo](#DataInfo) <sub><a href="src/index.ts#L1801">src</a></sub>

### `chroma.limits`(_data_: number\[\] | [DataInfo](#DataInfo), _mode_: [LimitsMode](#LimitsMode) = "e", _num_: number = 7): number\[\] <sub><a href="src/index.ts#L1827">src</a></sub>
